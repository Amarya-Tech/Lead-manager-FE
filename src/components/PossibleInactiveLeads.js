...
export default function PossibleInactiveLeadsTable() {
    ...
    useEffect(() => {
        const fetchLeads = async () => {
            try {
                let response;
                const action = "";
                response = await apiClient.post(`/lead/fetch-inactive-leads/${userId}`, {
                    action : 'possible_inactive'
                });
